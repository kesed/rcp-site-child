...
<div class="wrapper">
    <section class="container-fluid features">
        ...
        <h1 class="ph-lg-9 align-lg-center mb-xs-1">Lock away your exclusive content. Give access to valued members.</h1>
        <p class="subtitle ph-lg-10 align-lg-center mb-xs-4">See some of the features below and learn why businesses trust Restrict Content Pro.</p>
...
<div class="wrapper">
    <section class="aligncenter pv-xs-2 pv-sm-4">
    	<h1 class="mb-xs-1">30 Day Money Back Guarantee.</h1>
    	<p class="subtitle mb-xs-6">We stand behind our product 100% <?php echo rcp_show_refund_policy_link(); ?></p>
...
<div class="wrapper">
    <section class="container-fluid aligncenter pv-xs-4">
    	...
    	<p class="subtitle"><a href="<?php echo site_url( 'screenshots'); ?>">View all <?php echo rcp_screenshot_count(); ?> screenshots</a></p>
