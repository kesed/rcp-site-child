...
<section class="container-fluid hero ph-md-4 ph-lg-8">
...
<section class="container-fluid features ph-md-4 ph-lg-8">

    <h1 class="ph-lg-5 align-lg-center mb-xs-1">Lock away your exclusive content. Give access to valued members.</h1>
    <p class="subtitle ph-lg-8 align-lg-center mb-xs-4">See some of the features below and learn why businesses trust Restrict Content Pro.</p>
