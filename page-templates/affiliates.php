...
<header class="page-header<?php echo themedd_page_header_classes(); ?>">
	<h1 class="page-title">
		...
		<span class="subtitle">Use and love Restrict Content Pro? Become an affiliate and earn 20% commission on each successful sale you refer!</span>
	</h1>
</header>
    ...
    <div class="wrapper">
        ...
        <div class="row center-xs aligncenter">
            <div class="col-xs-12 col-sm-4">
				...
				<img class="mb-xs-1" width="96" height="96" src="<?php echo get_stylesheet_directory_uri() . '/images/svgs/combined/refer-and-earn.svg'; ?>" />



                <h2>Refer and earn</h2>
                <p class="mb-lg-0">Refer customers to Restrict Content Pro and earn 20% commission on each successful sale. Enjoy uncapped, unlimited commissions!</p>

            </div>

            <div class="col-xs-12 col-sm-4">
				<img class="mb-xs-1" width="96" height="96" src="<?php echo get_stylesheet_directory_uri() . '/images/svgs/combined/high-quality-banners.svg'; ?>" />

                <h2>High quality banners</h2>
                <p class="mb-lg-0">Get up and running in minutes with our ready-to-go affiliate banners. Place these banners on your site and start promoting Restrict Content Pro instantly.</p>

            </div>

            <div class="col-xs-12 col-sm-4">
				<img class="mb-xs-1" width="96" height="96" src="<?php echo get_stylesheet_directory_uri() . '/images/svgs/combined/detailed-referral-statistics.svg'; ?>" />
