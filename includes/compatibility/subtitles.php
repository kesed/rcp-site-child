 ...
 * @since 1.0.0
 */
function rcp_theme_post_header_custom( ) {
   add_filter( 'subtitle_view_supported', '__return_true' );
}
add_action( 'themedd_post_header_before', 'rcp_theme_post_header_custom' );
 ...
 * @since 1.0.0
 */
function rcp_theme_post_header_remove_custom( ) {
	add_filter( 'subtitle_view_supported', '__return_false' );
}
add_action( 'themedd_post_header_end', 'rcp_theme_post_header_remove_custom' );
 ...
 * @since 1.0.0
 */
function rcp_theme_subtitle_markup( $markup ) {

    $markup['before'] = '<span class="subtitle">';

    return $markup;
}
add_filter( 'subtitle_markup', 'rcp_theme_subtitle_markup' );
